return {
  ...
  -- Stole this look from Coding with Sphere video "11 Small but Useful Neovim Plugins"
    keys = {
      ...
      { "<A-l>",  function() require("smart-splits").resize_right() end,  desc = "Resize down" },
      ...
      -- All this is easy enough with just other mapping I have. Keep here in the event I change my mind
      -- { "<leader><leader>j", function() require("smart-splits").swap_buf_down() end, desc = "" },
      -- { "<leader><leader>k", function() require("smart-splits").swap_buf_up() end, desc = "" },
      -- { "<leader><leader>l", function() require("smart-splits").swap_buf_right() end, desc = ""},
    },
    opts = {
      ignored_buftypes = {
        'nofile',
